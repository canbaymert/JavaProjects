...
public class C03_guessTheMovie {
    static List<String> film = new ArrayList<>(Arrays.asList("CITYOFGOD", "SPIDERMAN", "THEBbankAN", "THEWOLFOFWALLSTREET", "THESIXTHSENSE", "SLUMDOGMILLIONAIRE",
            "HANNIBAL", "THESILENCEOFLAMBS", "SINCITY", "THEREVENANT", "RUSH", "THETHING", "THELASTSAMURAI", "THEEXORCIST", "THELIVESOFOTHERS", "AMERICANBEAUTY",
            "AMERICANHISTORYX", "AMELIE", "XMEN", "OLDBOY", "THEAMERICANPIE", "ONEFLEWOVERTHECUCKOOSNEST", "TOYSTORY", "THESHINING", "THEDARKKNIGHTRISES", "BbankANBEGINS",
